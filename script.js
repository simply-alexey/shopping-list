...
document.getElementById("addBtnTop").onclick = () => document.getElementById("modalOverlay").classList.add("active");
document.getElementById("cancelBtn").onclick = () => document.getElementById("modalOverlay").classList.remove("active");
